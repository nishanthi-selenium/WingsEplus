...
// driver utils and string utils implementation pending

public abstract class GuiActionUtils {

	public static long PAGE_LOAD_TIMEOUT = 20;

	public GuiActionUtils() {
	...
	public void navigateBack() {
		try {
			...
			System.out
					.println("FAILURE: Could not navigate back to previous page.");
	...
	public String getCurrentURL() {
		try {
			...
			throw new TestException(String.format("Current URL is: %s",
	...
	public WebElement getElement(By selector) {
		try {
			...
			System.out.println(String.format(
					"Element %s does not exist - proceeding", selector));
		}
		return null;
	}
	...
	public List<WebElement> getElements(By Selector) {
		...
		try {
			...
			throw new NoSuchElementException(String.format(
					"The following element did not display: [%s] ",
					Selector.toString()));
		}
	}
		...
		for (WebElement element : elements) {
			if (element == null) {
				throw new TestException(
						"Some elements in the list do not exist");
			}
	...
	public void click(By selector) {
		...
		try {
			...
			throw new TestException(String.format(
					"The following element is not clickable: [%s]", selector));
		}
	}
	...
	public void scrollToThenClick(By selector) {
		...
		try {
			...
			throw new TestException(String.format(
					"The following element is not clickable: [%s]",
					element.toString()));
		}
	}
	...
	public void sendKeys(By selector, String value) {
		...
		try {
			...
			throw new TestException(String.format(
					"Error in sending [%s] to the following element: [%s]",
	...
	public void clearField(WebElement element) {
		try {
			...
			System.out.print(String.format(
					"The following element could not be cleared: [%s]",
					element.getText()));
		}
	}
	...
	public void waitForElementToBeVisible(By selector) {
		try {
			wait = new WebDriverWait(_driver, PAGE_LOAD_TIMEOUT);
			wait.until(ExpectedConditions.presenceOfElementLocated(selector));
		} catch (Exception e) {
			throw new NoSuchElementException(String.format(
					"The following element was not visible: %s", selector));
		}
	}
	...
	public void selectIfOptionTextContains(By selector, String searchCriteria) {
		...
		if (options == null) {
			throw new TestException(
					"Options for the dropdown list cannot be found.");
		}
